...
// GET ALL MOVIES
export const moviesListReducer = (state = {movies: []}, action: { type: any; payload: { movies: any; pages: any; page: any; totalMovies: any; }; }) => {
    switch (action.type) {
...
// GET RANDOM MOVIES
export const moviesRandomReducer = (state = {movies: []}, action: { type: any; payload: any; }) => {
    switch (action.type) {
...
// GET MOVIE BY ID
export const movieDetailsReducer = (state = {movie: {}}, action: { type: any; payload: any; }) => {
    switch (action.type) {
...
export const movieTopRatedReducer = (state = {movies: []}, action: { type: any; payload: any; }) => {
    switch (action.type) {
...
// CREATE REVIEW
export const createReviewReducer = (state = {}, action: { type: any; payload: any; }) => {
    switch (action.type) {
...
// DELETE MOVIE
export const deleteMovieReducer = (state = {}, action: { type: any; payload: any; }) => {
    switch (action.type) {
...
// DELETE ALL MOVIES
export const deleteAllMoviesReducer = (state = {}, action: { type: any; payload: any; }) => {
    switch (action.type) {
...
// CREATE MOVIE
export const createMovieReducer = (state = {}, action: { type: any; payload: any; }) => {
    switch (action.type) {
...
// CASTS
export const CastsReducer = (state = {casts: []}, action: { type: any; payload: { id: any; }; }) => {
    switch (action.type) {
        case moviesConstants.ADD_CAST:
            return {casts: [...state.casts, action.payload]};
        case moviesConstants.EDIT_CAST:

            const updatedCasts = state.casts.map((cast: any) =>
...
// UPDATE MOVIE
export const updateMovieReducer = (state = {}, action: { type: string; payload: any; }) => {
    switch (action.type) {
