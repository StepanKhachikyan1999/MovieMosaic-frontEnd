...
// GET ALL CATEGORIES
export const getAllCategoriesReducer = (state = {categories: []}, action: { type: string; payload: any; }) => {
    switch (action.type) {
...
// CREATE CATEGORY
export const createCategoryReducer = (state = {}, action: { type: string; payload: any; }) => {
    switch (action.type) {
...
// UPDATE CATEGORY
export const updateCategoryReducer = (state = {}, action: { type: string; payload: any; }) => {
    switch (action.type) {
...
// DELETE CATEGORY
export const deleteCategoryReducer = (state = {}, action: { type: string; payload: any; }) => {
    switch (action.type) {
