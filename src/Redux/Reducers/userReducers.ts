...
// DELETE PROFILE
export const userDeleteProfileReducer = (state = {}, action: { type: any; payload: any; }) => {
    switch (action.type) {
...
// CHANGE PASSWORD
export const userChangePasswordReducer = (state = {}, action: { type: any; payload: { message: any; }; }) => {
    switch (action.type) {
...
export const userDeleteFavoriteMoviesReducer = (state = {}, action: { type: string; payload: any; }) => {
    switch (action.type) {
...
// ADMIN GET ALL USERS
export const adminGetAllUsersReducer = (state = {users: []}, action: { type: string; payload: any; }) => {
    switch (action.type) {
...
// ADMIN DELETE USER
export const adminDeleteUserReducer = (state = {}, action: { type: string; payload: any; }) => {
    switch (action.type) {
...
// USER LIKE MOVIE
export const userLikeMovieReducer = (state = {}, action: { type: string; payload: any; }) => {
    switch (action.type) {
