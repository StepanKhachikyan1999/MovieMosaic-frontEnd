...
// login action
const loginAction = (datas: any) => async (dispatch: any) => {
    try {
...
// register action
const registerAction = (datas: any) => async (dispatch: any) => {
    try {
...
const updateProfileAction = (user: any) => async (dispatch: any, getState: any) => {
    try {
...
const deleteProfileAction = () => async (dispatch: any, getState: any) => {
    try {
...
const changePasswordAction = (passwords: any) => async (dispatch: any, getState: any) => {
    try {
...
const getFavoriteMoviesAction = () => async (dispatch: any, getState: any) => {
    try {
...
const deleteFavoriteMoviesAction = () => async (dispatch: any, getState: any) => {
    try {
...
const getAllUsersAction = () => async (dispatch: any, getState: any) => {
    try {
...
const deleteUserAction = (id: number) => async (dispatch: any, getState: any) => {
    try {
...
const likeMovieAction = (movieId: any) => async (dispatch: any, getState: any) => {
    try {
