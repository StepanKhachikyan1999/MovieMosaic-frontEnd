    ...
    return (
        <div className="my-16">
            ...
            <div className="mt-10">
                ...
                >
                    {Movies.map((movie: { titleImage: any; name: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined; rate: any; }, index: React.Key | null | undefined) => (
                        <SwiperSlide key={index}>
                            <div className="p-4 h-rate hovered border border-border bg-dry rounded-lg overflow-hidden">
                                ...
                                {movie.titleImage}
                                <div
                                    className="px-4 hoveres gap-6 text-center absolute bg-black bg-opacity-70 top-0 left-0 right-0 bottom-0">
                                    <button
                ...
                <div className="w-full px-1 flex-rows gap-6 pt-12">
                    ...
                    <button className={classNames} ref={(node) => setNextEl(node as any)}>
                        <BsCaretRightFill/>
                    </button>
                </div>
            </div>
