            ...
            <div className="mt-10 xl:grid flex-colo grid-cols-5 gap-12 bg-dry xs:p-10 py-10 px-2 sm:p-20 rounded">
                ...
                <div className="xl:col-span-2 w-full flex flex-col gap-8">
                    ...
                    <div className="text-sm w-full">
                        <Select
                            label="Select Rating"
                            options={Ratings}
                            onChange={(e: { target: { value: React.SetStateAction<undefined>; }; }) => setRating(e.target.value)}
                        />
                ...
                <div className="col-span-3 flex flex-col gap-6">
                    ...
                    <div
                        ...
                        {UsersData.map((user: { image: any; fullName: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | null | undefined; message: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; rate: any; }, i: any) => (
                            <div
