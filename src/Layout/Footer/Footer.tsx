        ...
        <div className='bg-dry py-4 border-t-2 border-black'>
            <div className='container mx-auto px-2'>
                <div
                    ...
                    {
                        Links.map((link: { title: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | Iterable<React.ReactNode> | React.ReactPortal | null | undefined; links: any[]; }, i: React.Key | null | undefined) => {
                            return (
                        ...
                        <p className='leading-7 text-sm text-border mt-3'>
                            <span>
                              Lorem ipsum dolor sit amet, consectetur adipisicing <br/>
                                elit. Enim eos eveniet nulla quia
                            </span><br/>
                            <span>
                                Tel: +8999999999
                            </span> <br/>
